...
/**
 * This class is a controller for the AddAppointment view.
 * It contains the methods onActionAddFirstLevelDivisions, addContacts, addUsers,
 * onAddAppointment, onActionDisplayMenu, and initialize
 */
public class AddAppointment implements Initializable {
    ...
    /**
     * ObservableLists used for populating TableViews and ComboBoxes
     */
     ...
     * it performs error checks and then adds the newly created appointment to the database.
     * @param actionEvent
     * @throws IOException
     */
